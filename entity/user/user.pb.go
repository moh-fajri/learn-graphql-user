...
var file_user_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x22, 0x39, 0x0a, 0x0d, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x22, 0x0b, 0x0a,
	0x09, 0x4e, 0x6f, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x30, 0x0a, 0x0c, 0x55, 0x73,
	...
	0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x05, 0x75, 0x73, 0x65, 0x72, 0x73, 0x22, 0x40, 0x0a, 0x04,
	...
	0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x32, 0x6d,
	0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x2b, 0x0a,
	0x04, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x0f, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x4e, 0x6f, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x12, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x55, 0x73,
	0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x31, 0x0a, 0x06, 0x43, 0x72,
	...
	0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x04, 0x5a,
...
var file_user_proto_goTypes = []interface{}{
	...
	(*NoRequest)(nil),     // 1: user.NoRequest
	(*UserResponse)(nil),  // 2: user.UserResponse
	(*User)(nil),          // 3: user.User
}
var file_user_proto_depIdxs = []int32{
	3, // 0: user.UserResponse.users:type_name -> user.User
	1, // 1: user.UserService.List:input_type -> user.NoRequest
	0, // 2: user.UserService.Create:input_type -> user.CreateRequest
	2, // 3: user.UserService.List:output_type -> user.UserResponse
	2, // 4: user.UserService.Create:output_type -> user.UserResponse
...
type UserServiceClient interface {
	List(ctx context.Context, in *NoRequest, opts ...grpc.CallOption) (*UserResponse, error)
...
func (c *userServiceClient) List(ctx context.Context, in *NoRequest, opts ...grpc.CallOption) (*UserResponse, error) {
...
type UserServiceServer interface {
	List(context.Context, *NoRequest) (*UserResponse, error)
...
func (*UnimplementedUserServiceServer) List(context.Context, *NoRequest) (*UserResponse, error) {
...
func _UserService_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).List(ctx, req.(*NoRequest))
	}
